...
BOT_TOKEN = environ.get('BOT_TOKEN', "8068805058:AAH1b1S9-VWTRidzFGkThGjoxycllPoP5I4")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002148375787 -1002133505201').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002522695655')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://demo2main:demo2main@cluster05875444.6framb1.mongodb.net/?appName=Cluster05875444")
