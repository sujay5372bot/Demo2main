...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6942557751 7336971189').split()]
OWNER_ID = [int(owner) if id_pattern.search(owner) else owner for owner in environ.get('OWNER_ID', '6942557751 7336971189').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002148375787 -1002133505201 -1002445219066').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002522695655') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002522695655')
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://Sjdjhdbdbd:Sjdjhdbdbd@cluster0836483846.qj2ol2r.mongodb.net/?appName=Cluster0836483846")
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '6b6558a80696400e19688fe48e278677305411f2')
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'linkpays.in')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '6b6558a80696400e19688fe48e278677305411f2')
